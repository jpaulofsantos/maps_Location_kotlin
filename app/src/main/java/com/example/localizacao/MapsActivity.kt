...
import com.example.localizacao.databinding.ActivityMapsBinding
...
class MapsActivity : AppCompatActivity(),
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        // definindo uma posião fixa do marcador no mapa
        //val myPlace = LatLng(40.73, -73.99)
        //map.addMarker(MarkerOptions().position(myPlace).title("My favorite place!"))
    ...
    private fun placeMarkerOnMap(location: LatLng) {
        ...
        val titleString = getAdress(location)
